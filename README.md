...
The test suite adds 183 more: the CLI and its error messages, the on-disk contract, cache
...
and a name re-exported through a package's __init__ — and codegraph reading its own source.
