...
The test suite adds 328 more: the CLI and its error messages, the on-disk contract, cache
...
and a hand-written tree walk checked node type by node type against the standard one
