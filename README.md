...
```json
{
  "call_edges": 5482,
  "call_sites": 7222,
  "edge_confidence": {"EXTERNAL": 2938, "INHERITED": 731, "BUILTIN": 583, "SELF-METHOD": 541,
                      "QUALIFIED": 320, "LOCAL": 197, "UNTYPED": 164, "TYPED": 5,
                      "CONSTRUCTOR": 3, "AMBIGUOUS": 0},
  "resolved_to_one_def": 1797,
  "could_have_been_resolved": 1961,
...
That 0.916 says: of the calls that could plausibly have gone to something in this codebase,
...
**The file admits 1,140 mutations.** The last full pass killed every one of the 987 the file
admitted then, and the file has grown since — an MCP server, a shape reader, a saving footer and an incompleteness warning,
which are 153 of those mutations
...
The test suite adds 703 more. Grouped, because a list of every one of them stopped being
