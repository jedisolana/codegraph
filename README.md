...
The test suite adds 320 more: the CLI and its error messages, the on-disk contract, cache
...
and a rename that Windows refuses while another process is reading the file
